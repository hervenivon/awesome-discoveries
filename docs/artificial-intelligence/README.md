...
* [Advanced Technology External Advisory Council (ATEAC)](https://www.technologyreview.com/s/613203/google-appoints-an-ai-council-to-head-off-controversy-but-it-proves-controversial/) - A team made of philosophers, engineers, and policy experts will regulate Google's AI projects based on their [AI principles](https://www.blog.google/technology/ai/ai-principles/). For the moment, this initiative is creating controversy.
